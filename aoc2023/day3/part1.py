...
for symbol_x, symbol_line in symbols:
    result += get_close_number_value(numbers, symbol_x - 1, symbol_line - 1)
    result += get_close_number_value(numbers, symbol_x, symbol_line - 1)
    result += get_close_number_value(numbers, symbol_x + 1, symbol_line - 1)
    result += get_close_number_value(numbers, symbol_x + 1, symbol_line)
    result += get_close_number_value(numbers, symbol_x + 1, symbol_line + 1)
    result += get_close_number_value(numbers, symbol_x, symbol_line + 1)
    result += get_close_number_value(numbers, symbol_x - 1, symbol_line + 1)
    result += get_close_number_value(numbers, symbol_x - 1, symbol_line)
